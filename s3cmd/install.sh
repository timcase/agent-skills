...
# install.sh
# Installs the "s3cmd" skill from timcase/agent-skills into ~/.claude/skills/s3cmd
#
# Behavior:
# - Default (recommended): clone repo once into ~/.claude/skills/agent-skills and symlink s3cmd
...
# e.g. "skills/s3cmd" for "s3cmd", or "skills/foo" for "tools/foo"
