...
SKILLS=("1password" "aws-cli" "azuracast" "beets" "cinc-client" "cloudflare" "doctl" "gh-cli" "hcloud" "knife" "musicbrainz" "newrelic" "postmark" "proton-pass" "s3cmd" "sentry" "skill-creator" "spotify")
